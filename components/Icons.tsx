...
export const StatAiIcon: React.FC<{ className?: string }> = ({ className = "w-7 h-7" }) => (
...
export const BriefcaseIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25v-4.07a2.25 2.25 0 0 1 2.25-2.25h12A2.25 2.25 0 0 1 20.25 14.15Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 11.25V9a2.25 2.25 0 0 0-2.25-2.25h-9A2.25 2.25 0 0 0 5.25 9v2.25" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 6.75a2.25 2.25 0 0 0-2.25-2.25H11.25A2.25 2.25 0 0 0 9 6.75" />
    </svg>
);
...
export const OwlIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9 10.5c0 .828.672 1.5 1.5 1.5s1.5-.672 1.5-1.5S11.328 9 10.5 9s-1.5.672-1.5 1.5z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M13.5 10.5c0 .828.672 1.5 1.5 1.5s1.5-.672 1.5-1.5S15.828 9 15 9s-1.5.672-1.5 1.5z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 14.25c-.5 1-1.5 1.5-1.5 1.5h3s-1-.5-1.5-1.5z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M7.5 6.75S9 5.25 12 5.25s4.5 1.5 4.5 1.5"
      />
    </svg>
);
...
export const TrophyIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 0 1 9.75-9.75v1.5A2.25 2.25 0 0 1 15 12.75v-1.5a9.75 9.75 0 0 1-9.75 9.75" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75v5.25m6-5.25v5.25m-3-5.25V21M3 13.5h18" />
    </svg>
);

export const GiftIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v8.25a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 19.5v-8.25a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 11.25Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.875c-2.054 0-4.134.202-6.143.585m12.286 0c-2.009-.383-4.089-.585-6.143-.585m0 0V9.375m0-4.5c1.406 0 2.731.255 3.938.718m-7.876 0c1.207-.463 2.532-.718 3.938-.718m0 0c2.306 0 4.434.462 6.309 1.253" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.375v11.25" />
...
export const SpeakerWaveIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5l.415-.207a.75.75 0 011.085.67V10.5m0 0h6m-6 0a.75.75 0 001.085.67l.415-.207M8.25 10.5V7.5m0 3V12m0 0a.75.75 0 00-1.085-.67l-.415.207M3 10.5a.75.75 0 001.085.67l.415-.207M3 10.5V7.5m0 3V12m0 0a.75.75 0 001.085.67l.415-.207M3 12a9 9 0 1018 0a9 9 0 00-18 0z" />
    </svg>
);

export const MapIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 20.25h6m-6 0a3.375 3.375 0 01-3.375-3.375V6.375A3.375 3.375 0 019 3h6a3.375 3.375 0 013.375 3.375v10.5A3.375 3.375 0 0115 20.25m-6 0h6m-6 0H6.375a3.375 3.375 0 01-3.375-3.375V6.375a3.375 3.375 0 013.375-3.375h9.25a3.375 3.375 0 013.375 3.375v10.5a3.375 3.375 0 01-3.375 3.375H9.375" />
    </svg>
);

export const MicrophoneIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5a6 6 0 00-12 0v1.5a6 6 0 006 6zM12 12.75V18.75m0-6c-1.036 0-1.875.84-1.875 1.875v.375c0 1.036.84 1.875 1.875 1.875s1.875-.84 1.875-1.875v-.375c0-1.036-.84-1.875-1.875-1.875z" />
    </svg>
);
